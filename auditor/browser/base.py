...
Current implementations:
  auditor.tools.BrowserSession          — Playwright sync API
  auditor.platforms.ivalua.IvaluaBrowserSession — Playwright + Ivalua-specific helpers

Future:
  auditor.browser.selenium.SeleniumAdapter   — V2 / legacy SaaS targets
"""
